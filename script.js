...
let isDeveloper = localStorage.getItem('isDeveloper') === 'true';
...
function approveApplication(id) {
    ...
    if (application) {
        ...
        application.processedAt = new Date().toLocaleDateString('ru-RU');
        saveApplications();
        loadApplications();
...
function simulateEmailSend(email, subject, message) {
    console.log(`=== Email отправлен на ${email} ===`);
    console.log(`Тема: ${subject}`);
    console.log(`Сообщение:\n${message}`);
    console.log('================================');
    
    // Сохраняем отправленные email в localStorage
